...
export default function LoginPage(props: PageProps<{supabaseUrl: string, supabaseAnonKey: string}>) {
  return (
    <>
      <Header/>
        <div className="py-20 px-10">
          ...
          <UserLogin supabaseUrl={props.data.supabaseUrl} supabaseAnonKey={props.data.supabaseAnonKey}/>
          <div>
