  ...
  return (
    <>
      ...
      <div className="bg-[#f7f6ed] min-h-screen">
        ...
        />
        <div className="relative md:bg-[url(/main_pic.webp)] bg-[url(/main_pic_mobile.webp)] bg-cover bg-center lg:h-[850px] h-[400px]">
          ...
          <div className="relative z-10 flex flex-col lg:items-start items-center justify-center h-full text-center text-white lg:px-[120px] pb-[100px]">
            <div className="flex flex-col items-center text-left text-white max-w-2xl">
              <h1 className="lg:text-5xl text-2xl font-bold mb-2">
        ...
        <div className="lg:py-20 py-10">
          ...
          <div className="flex lg:flex-row flex-col justify-center items-center gap-10 mt-16">
            <div className="flex flex-col items-center justify-center p-4 max-w-md lg:h-[600px]">
              <img
                src="/klassikaline_jooga_main.webp"
                alt="Klassikaline jooga"
            ...
            <div className="flex flex-col items-center justify-center p-4 max-w-md lg:h-[600px]">
              ...
              <p className="text-gray-700 text-lg text-center">
                ...
                aitavad võtta sügavamaid joogaasendeid.
              </p>
            </div>
            <div className="flex flex-col items-center justify-center p-4 max-w-md lg:h-[600px]">
              <img
                src="/paarisjooga_main.webp"
                alt="Acro-paarisjooga"
                className="w-[300px] h-[400px] object-cover rounded-lg"
                loading="lazy"
              />
              <h3 className="text-xl font-bold m-4">Acro-paarisjooga</h3>
              <p className="text-gray-700 text-lg text-center">
                Paarisjooga õpetab kuulama partnerit ja otsima tasakaalu, pannes
                end proovile nii füüsilisel kui vaimsel tasandil.
              </p>
            </div>
          </div>
        ...
        <div className="flex flex-col items-center justify-center py-20 bg-[#F2E2CE]">
          ...
          <div className="flex lg:flex-row flex-col gap-10 mt-16 max-w-3xl w-full">
            <div className="text-lg lg:w-1/2 flex flex-col justify-between p-4">
              <p>
                “Olen joogaga tegelenud viimased pool aastat. Läksin joogasse,
                et saada leevendust seljavaludele. Tänu joogale olen saanud
                painduvust ja liikuvust juurde. Samuti on joogaga tegelemine
                muutnud emotsionaalselt positiivsemaks ja tasakaalukamaks.“
              </p>
            ...
            <div className="text-lg lg:w-1/2 flex flex-col justify-between p-4">
              <p>
                “Jooga on minu elus uus kogemus. Tänu juhendajale olen saanud
                parema tervise. Keha on aktiivsem ja seljavalud kadunud. Keha ja
                vaim tasakaalus.”
              </p>
          ...
          <div className="flex lg:flex-row flex-col items-start justify-center gap-16 pb-20">
            <div className="flex flex-col">
              ...
              <p className="text-lg text-gray-700">
                Pikk tn 51, Rakvere, Lääne-Viru maakond
              </p>
            </div>
            <iframe
              title="Google Maps"
