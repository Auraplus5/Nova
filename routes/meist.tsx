  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Tutvu Nova Tervise Stuudio tiimiga ja meie tegemistega. Meist leiad pühendunud juhendajad ja inspireeriva keskkonna."
        />
        <meta
          name="keywords"
        ...
        <div className="flex lg:flex-row flex-col lg:items-start items-center justify-center gap-16 p-10 max-w-7xl mx-auto">
          ...
          <div className="max-w-2xl">
            ...
            <p className="text-lg text-gray-700 mb-4">
              ...
              jätkan ma enda täiendamist osaledes erinevatel koolitustel
              Euroopas (Scott Johnson 20h, Mayra Surya 25h, Laste jooga kool
              400h) ja Indias (Tattvaashram Yogshala Varkala 20h, Samatva
              Yogalaya ashram Rishikesh 200h, Yogadarshanam Mysure 300h). Lisaks
              joogale lõpetasin Visible Feels Akadeemia pilatese koolituse kuna
              arvan, et jooga ja pilates on suurel määral kooskõlas.
              <br />
              <br />
              ...
              praktiseerimist ning aitab saavutada ja säilitada optimaalse
              tervise enda kehas. Lisaks olen organiseerinud lastelaagreid ja
              retriite ning praktiseerinud põnevaid stiile nagu SUP-laua jooga,
              õhujooga ja joogateraapia
              <br />
              <br />
              ...
              Samas meeldib mulle ka võtta aega, et ühele stiilile pühenduda,
              kuna see toob meid hetkesse, maandab ning aitab keskenduda. Usun,
              et igal inimesel on joogas oma teekond ja see on väga
              individuaalne. Olenemata stiilist on oluline, et teeksime seda
              järjepidevalt ja õpiksime teadliku jooga praktiseerimist, kuna see
              kajastub ka meie igapäevases elus. Sedasi tehes oleme 100% ärkvel
              ja elame hetkes, mis tõstab meie elukvaliteeti ja teeb meid
              õnnelikuks.
              <br />
              <br />
              Lisaks joogale meeldib mulle tutvuda erinevate riikide
              traditsioonide, usu ja kultuuriga ning seepärast õppisin
              Rahvusvahelisi suhteid London Queen Mary ülikoolis ja olen
              endiselt huvitatud kultuuridiplomaatiast. Usun, et mitmekesisuse
