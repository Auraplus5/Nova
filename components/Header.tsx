        ...
        <div class="flex items-center gap-6">
          <nav class="hidden xl:block">
            <ul class="flex space-x-6 text-lg">
              ...
              <li>
                <a href="/tunniplaan" className="hover:text-[#af6b30]">
                  Tunniplaan
                </a>
              </li>
              <li>
                <a href="/tuleKutsu" className="hover:text-[#af6b30]">
                  Tule/Kutsu külla
                </a>
              </li>
              <li>
                <a href="/uritused" className="hover:text-[#af6b30]">
                  Üritused
                </a>
              </li>
              <li>
              ...
              {role === "admin" && (
                <li>
                  <a href="/admin/timetable" className="hover:text-[#af6b30]">
                    Admin
                  </a>
                </li>
              )}
              {user && (
                <li>
                  <a href={`/user/${user.id}`} className="hover:text-[#af6b30]">
                    Minu Broneeringud
                  </a>
                </li>
              )}
          ...
          <div class="flex items-center gap-3 px-15">
            ...
            >
              <img
                ...
                alt="Nova Tervise Stuudio Facebooki leht"
                width="24"
                height="24"
              />
            </a>
            ...
            >
              <img
                ...
                alt="Nova Tervise Stuudio Instagrami leht"
                width="24"
                height="24"
              />
            </a>
